...
void setup()
{
  ...
  master_vol = 0.9375*analogRead(A1)-796.875;
  main_vol = 0.9375*analogRead(A2)-796.875;
  sub_vol = 0.9375*analogRead(A0)-796.875;
...
void loop()
{
  ...
  heart_beat(cnt);
  master_vol = 1.1875*analogRead(A1)-1031.88;
  main_vol = 1.1875*analogRead(A2)-1031.88;
  sub_vol = 1.1875*analogRead(A0)-1031.88;
  theAudio->setVolume(master_vol,main_vol,sub_vol);
